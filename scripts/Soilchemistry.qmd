...
dat <- read_csv("https://github.com/jdebruyn/ARF-seasonal/raw/refs/heads/main/pH_EC_etc_SP.csv") %>%
    ...
    select(-Location, -Date, -TBS, -Sorting) %>%
    ...
    mutate(parameter = factor(parameter, 
                              ...
                              labels = c("Air Temperature", "Soil Temperature", "Gravimetric Moisture", "pH", "EC" , "DO", "CO~2~ (μg gdw<sup>-1</sup>)", "NH~4~ (mg gdw<sup>-1</sup>)", "NO~3~ (mg gdw<sup>-1</sup>)", "% N", "% C", "C:N")))
...
```{r}
write.csv(dat, here::here("data/SP_recombined_soildata.csv"))
```
