...
rows <- c("ADH\\textsubscript{A}", "ADH\\textsubscript{I}", "ADH\\textsubscript{S}", "T\\textsubscript{A}", "T\\textsubscript{S}", "GWC", "pH", "EC", "DO", "CO\\textsubscript{2}", "NH\\textsubscript{4}", "NO\\textsubscript{3}", "N \\%", "C \\%", "C:N", "Residuals", "Total")
