...
\abstract{Vertebrate decomposition is a key ecosystem process in
terrestrial environments, altering the soil environment and nutrient
pools (C, N, S, etc.). Soil microbial communities are hypothesized to
drive biogeochemical cycling in these ephemerial hotspots, however it is
unclear which members are active or metabolic pathways they might be
expressing. This has left a foundational knowledge gap regarding the
functional roles of microorganisms in vertebrate decomposition. We use
metatranscriptomes obtained from soil samples collected over the course
of one year from below three decomposing human bodies to address this
knowledge gap. Computational analyses reveal shifts in gene expression
as decomposition progressed, remaining altered after one year. Microbes
in decomposition soils displayed increased expression of heat shock
proteins, whose expression increased between days 0 and 58 and remained
elevated through day 376. Further, expression nitrogen cycling genes
coincides soil dissolved oxygen and suggests that microbial communities
may be converting hydroxylamine to nitric oxide and reducing nitrous
oxide to nitrogen gas during reduced oxygen conditions. Together, we
show that human decomposition alters soil microbial gene expression,
providing evidence of altered microbial metabolisms (\emph{e.g.},
taurine metabolism, nitrogen cycling, and lipid metabolism) and reveal
the potential of vertebrate decomposition to have both ephemeral and
lasting effects on ecosystem processing in response to mortality
events.}
...
assess the impacts of vertebrate decomposition on ecosytem functioning
by characterizing community-level shifts in soil microbial function. We
hypothesize that: (i) gene expression would change over time as
resources are used and transformed and soil chemical and physical
conditions change due to the influx of decomposition products during
...
will be altered, as changes in nitrogen pools have been previously
described in decomposition soils \citep{keenan_mortality_2018}; (iii)
lipid metabolism will increase, as we expect lipids from the body to
enter the soil during decomposition and previous studies showed an
increase of lipolytic organisms in decomposition soils
\citep{howard_characterization_2010, mason_body_2022}; (iv) soil
expression profiles will not return to pre-decomposition conditions as
multiple studies have shown soil chemistry
...
amplicon sequencing) are still impacted after one year. We analyzed
metatranscriptomes of soil samples collected at six key timepoints over
one year of human decomposition to determine the active populations and
expression of genes and pathways relevant to the enhanced biogeochemical
cycling observed in decomposition hotspots. We compared gene expression
between decomposition timepoints and control soils that were unexposed
to decomposition products to identify functions or functional pathways
of interest. We show: (i) that decomposition impacts soil microbial
community gene expression after one year; (ii) expression of genes for
stress response are elevated in decomposition soils; (iii) expression of
genes encoding triacylglycerol lipase differed between fungal
(increased) and bacterial (decreased) organisms; (iv) evidence for
phased nitrification and denitrification, driven by changes in soil
dissolved oxygen; (v) evidence for organic sulfur processing (taurine)
via bile salt hydrolases. This assessment of functional profiles within
decomposition-impacted soils provides insight into the microbial
response(s) to vertebrate decomposition in terrestrial settings and
...
This study represents a novel investigation of soil microbial gene
