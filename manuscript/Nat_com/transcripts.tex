...
\abstract{\textbf{Background} During terrestrial vertebrate
decomposition, host and environmental microbial communities work
together to drive biogeochemical cycling of carbon and nutrients. These
mixed communities undergo dramatic restructuring in the resulting
decomposition hotspots. To reveal the succession of both the active
microbial members and the metabolic pathways they use, we generated
metatranscriptomes from soil samples collected over one year from below
three decomposing human bodies.

\textbf{Results} Soil microbes increased expression of heat shock
proteins in response to decomposition products changing physiochemical
conditions (\emph{i.e.}, reduced oxygen, high salt). Increased fungal
lipase expression implicated fungi as key decomposers of fat tissue.
Expression of nitrogen cycling genes was phased with soil oxygen
concentrations: during hypoxic soil conditions, genes catalyzing
N-reducing processes (\emph{e.g.}, hydroxylamine to nitric oxide and
nitrous oxide to nitrogen gas during reduced oxygen conditions) were
increased, followed by increased expression of nitrification genes once
oxygen diffused back into the soil. Increased expression of bile salt
hydrolases implicated a microbial source for the high concentrations of
taurine typically observed during vertebrate decomposition.

\textbf{Conclusions} Collectively, microbial gene expression profiles
remained altered even after one year. Together, we show how human
decomposition alters soil microbial gene expression, revealing both
ephemeral and lasting effects on soil microbial communities.}
...
\emph{Planctomycetes} (Fig. S3 B). The greatest number of differentially
expressed genes relative to control samples was observed at day 86,
where we saw 145,460 and 124,883 up- and down-regulated genes,
respectively.
...
Table S3 and Fig~\ref{fig-top-day-bar}.
...
zero and 12 (Fig~\ref{fig-top-day-bar}B, Table S3).
...
associated with \emph{tauD}, encoding taurine dioxygenase. (Table S3).
Further investigation into \emph{tauD} showed that mean expression of
these genes decreased steadily over one year, beginning at day 12
(Fig~\ref{fig-taud-bsh}B); however, \emph{tauD} expression in response
to human decomposition was variable across taxonomic associations. Most
\emph{tauD} transcripts were associated with \emph{Gammaproteobacteria},
\emph{Actinobacteria}, \emph{Betaproteobacteria},
\emph{Alphaproteobacteria}, and fungi. While a majority of the
\emph{tauD} gene queries displayed reduced expression over time,
expression of fungal-associated and a few
\emph{Betaproteobacteria}-associated \emph{tauD} genes increased at day
58 (Fig. S4). Sources of taurine in the human body include taurine
absorbed from the diet and taurine produced from anaerobic microbial
deconjugation of bile salts via bile salt hydrolase (BSH) enzymes
\citep{urdaneta_interactions_2017}. Therefore, we examined transcripts
encoding BSH enzymes in decomposition soils. Expression of these genes
was elevated at days 12, 58, and 86 before converging toward
...
\begin{thebibliography}{10}
  ...
  \bibitem{parmenter_carrion_2009}
  ...
  \bibinfo{author}{Aitkenhead-Peterson, J.~A.}, \bibinfo{author}{Owings, C.~G.}, \bibinfo{author}{Alexander, M.~B.}, \bibinfo{author}{Larison, N.} \& \bibinfo{author}{Bytheway, J.~A.}
  \newblock \bibinfo{title}{Mapping the lateral extent of human cadaver decomposition with soil chemistry}.
  \newblock \emph{\bibinfo{journal}{Forensic Science International}} \textbf{\bibinfo{volume}{216}}, \bibinfo{pages}{127--34} (\bibinfo{year}{2012}).
  
  \bibitem{keenan_mortality_2018}
  \bibinfo{author}{Keenan, S.~W.}, \bibinfo{author}{Schaeffer, S.~M.}, \bibinfo{author}{Jin, V.~L.} \& \bibinfo{author}{DeBruyn, J.~M.}
  \newblock \bibinfo{title}{Mortality hotspots: nitrogen cycling in forest soils during vertebrate decomposition}.
  \newblock \emph{\bibinfo{journal}{Soil Biology and Biochemistry}} \textbf{\bibinfo{volume}{121}}, \bibinfo{pages}{165--176} (\bibinfo{year}{2018}).
  
  \bibitem{fancher_evaluation_2017}
  \bibinfo{author}{Fancher, J.~P.} \emph{et~al.}
  \newblock \bibinfo{title}{An evaluation of soil chemistry in human cadaver decomposition islands: {Potential} for estimating postmortem interval ({PMI})}.
  \newblock \emph{\bibinfo{journal}{Forensic Science International}} \textbf{\bibinfo{volume}{279}}, \bibinfo{pages}{130--139} (\bibinfo{year}{2017}).
  
  \bibitem{quaggiotto_dynamic_2019}
  \bibinfo{author}{Quaggiotto, M.-M.}, \bibinfo{author}{Evans, M.~J.}, \bibinfo{author}{Higgins, A.}, \bibinfo{author}{Strong, C.} \& \bibinfo{author}{Barton, P.~S.}
  \newblock \bibinfo{title}{Dynamic soil nutrient and moisture changes under decomposing vertebrate carcasses}.
  \newblock \emph{\bibinfo{journal}{Biogeochemistry}} \textbf{\bibinfo{volume}{146}}, \bibinfo{pages}{71--82} (\bibinfo{year}{2019}).
  
  \bibitem{taylor_soil_2023}
  \bibinfo{author}{Taylor, L.~S.} \emph{et~al.}
  \newblock \bibinfo{title}{Soil elemental changes during human decomposition}.
  \newblock \emph{\bibinfo{journal}{PLoS ONE}} \textbf{\bibinfo{volume}{18}}, \bibinfo{pages}{1--24} (\bibinfo{year}{2023}).
  \newblock \bibinfo{note}{Publisher: Public Library of Science}.
  
  \bibitem{mason_body_2022}
  \bibinfo{author}{Mason, A.~R.} \emph{et~al.}
  \newblock \bibinfo{title}{Body mass index ({BMI}) impacts soil chemical and microbial response to human decomposition}.
  \newblock \emph{\bibinfo{journal}{mSphere}} \bibinfo{pages}{e0032522} (\bibinfo{year}{2022}).
  
  \bibitem{taylor_transient_2024}
  \bibinfo{author}{Taylor, L.~S.} \emph{et~al.}
  \newblock \bibinfo{title}{Transient hypoxia drives soil microbial community dynamics and biogeochemistry during human decomposition}.
  \newblock \emph{\bibinfo{journal}{FEMS Microbiology Ecology}} \textbf{\bibinfo{volume}{100}}, \bibinfo{pages}{fiae119} (\bibinfo{year}{2024}).
  
  \bibitem{keenan_microbial_2023}
  \bibinfo{author}{Keenan, S.~W.}, \bibinfo{author}{Emmons, A.~L.} \& \bibinfo{author}{DeBruyn, J.~M.}
  \newblock \bibinfo{title}{Microbial community coalescence and nitrogen cycling in simulated mortality decomposition hotspots}.
  \newblock \emph{\bibinfo{journal}{Ecological Processes}} \textbf{\bibinfo{volume}{12}}, \bibinfo{pages}{45} (\bibinfo{year}{2023}).
  
  \bibitem{mason_microbial_2023}
  \bibinfo{author}{Mason, A.~R.}, \bibinfo{author}{Taylor, L.~S.} \& \bibinfo{author}{DeBruyn, J.~M.}
  \newblock \bibinfo{title}{Microbial ecology of vertebrate decomposition in terrestrial ecosystems}.
  \newblock \emph{\bibinfo{journal}{FEMS Microbiology Ecology}} \textbf{\bibinfo{volume}{99}}, \bibinfo{pages}{fiad006} (\bibinfo{year}{2023}).
  
  \bibitem{burcham_total_2019}
  \bibinfo{author}{Burcham, Z.~M.} \emph{et~al.}
  \newblock \bibinfo{title}{Total {RNA} analysis of bacterial community structural and functional shifts throughout vertebrate decomposition}.
  \newblock \emph{\bibinfo{journal}{Journal of Forensic Sciences}} \textbf{\bibinfo{volume}{64}}, \bibinfo{pages}{1707--1719} (\bibinfo{year}{2019}).
  
  \bibitem{ashe_characterization_2021}
  \bibinfo{author}{Ashe, E.~C.}, \bibinfo{author}{Comeau, A.~M.}, \bibinfo{author}{Zejdlik, K.} \& \bibinfo{author}{O'Connell, S.~P.}
  \newblock \bibinfo{title}{Characterization of bacterial community dynamics of the human mouth throughout decomposition via metagenomic, metatranscriptomic, and culturing techniques}.
  \newblock \emph{\bibinfo{journal}{Frontiers in Microbiology}} \textbf{\bibinfo{volume}{12}}, \bibinfo{pages}{689493} (\bibinfo{year}{2021}).
  
  \bibitem{debruyn_comparative_2021}
  \bibinfo{author}{DeBruyn, J.~M.} \emph{et~al.}
  \newblock \bibinfo{title}{Comparative decomposition of humans and pigs: soil biogeochemistry, microbial activity and metabolomic profiles}.
  \newblock \emph{\bibinfo{journal}{Frontiers in Microbiology}} \textbf{\bibinfo{volume}{11}}, \bibinfo{pages}{608856} (\bibinfo{year}{2021}).
  
  \bibitem{howard_characterization_2010}
  \bibinfo{author}{Howard, G.~T.}, \bibinfo{author}{Duos, B.} \& \bibinfo{author}{Watson-Horzelski, E.~J.}
  \newblock \bibinfo{title}{Characterization of the soil microbial community associated with the decomposition of a swine carcass}.
  \newblock \emph{\bibinfo{journal}{International Biodeterioration \& Biodegradation}} \textbf{\bibinfo{volume}{64}}, \bibinfo{pages}{300--304} (\bibinfo{year}{2010}).
  
  \bibitem{cobaugh_functional_2015}
  \bibinfo{author}{Cobaugh, K.~L.}, \bibinfo{author}{Schaeffer, S.~M.} \& \bibinfo{author}{DeBruyn, J.~M.}
  \newblock \bibinfo{title}{Functional and structural succession of soil microbial communities below decomposing human cadavers}.
  \newblock \emph{\bibinfo{journal}{Plos One}} \textbf{\bibinfo{volume}{10}}, \bibinfo{pages}{e0130201} (\bibinfo{year}{2015}).
  
  \bibitem{singh_temporal_2018}
  \bibinfo{author}{Singh, B.} \emph{et~al.}
  \newblock \bibinfo{title}{Temporal and spatial impact of human cadaver decomposition on soil bacterial and arthropod community structure and function}.
  \newblock \emph{\bibinfo{journal}{Frontiers in Microbiology}} \textbf{\bibinfo{volume}{8}}, \bibinfo{pages}{2616} (\bibinfo{year}{2018}).
  
  \bibitem{urdaneta_interactions_2017}
  \bibinfo{author}{Urdaneta, V.} \& \bibinfo{author}{Casadesús, J.}
  \newblock \bibinfo{title}{Interactions between bacteria and bile salts in the gastrointestinal and hepatobiliary tracts}.
  \newblock \emph{\bibinfo{journal}{Frontiers in Medicine}} \textbf{\bibinfo{volume}{4}} (\bibinfo{year}{2017}).
  
  \bibitem{van_der_wal_thready_2013}
  \bibinfo{author}{van~der Wal, A.}, \bibinfo{author}{Geydan, T.~D.}, \bibinfo{author}{Kuyper, T.~W.} \& \bibinfo{author}{de~Boer, W.}
  \newblock \bibinfo{title}{A thready affair: linking fungal diversity and community dynamics to terrestrial decomposition processes}.
  \newblock \emph{\bibinfo{journal}{FEMS Microbiology Reviews}} \textbf{\bibinfo{volume}{37}}, \bibinfo{pages}{477--494} (\bibinfo{year}{2013}).
  
  \bibitem{essington_soil_2015}
  \bibinfo{author}{Essington, M.~E.}
  \newblock \emph{\bibinfo{title}{Soil and water chemistry: an integrative approach}}  (\bibinfo{publisher}{CRC press}, \bibinfo{year}{2015}).
  
  \bibitem{peng_short-term_2017}
  \bibinfo{author}{Peng, J.}, \bibinfo{author}{Wegner, C.-E.} \& \bibinfo{author}{Liesack, W.}
  \newblock \bibinfo{title}{Short-term exposure of paddy soil microbial communities to salt stress triggers different transcriptional responses of key taxonomic groups}.
  \newblock \emph{\bibinfo{journal}{Frontiers in Microbiology}} \textbf{\bibinfo{volume}{8}} (\bibinfo{year}{2017}).
  
  \bibitem{pandit_snapshot_2015}
  \bibinfo{author}{Pandit, A.~S.} \emph{et~al.}
  \newblock \bibinfo{title}{A snapshot of microbial communities from the {Kutch}: one of the largest salt deserts in the {World}}.
  \newblock \emph{\bibinfo{journal}{Extremophiles}} \textbf{\bibinfo{volume}{19}}, \bibinfo{pages}{973--987} (\bibinfo{year}{2015}).
  
  \bibitem{metcalf_microbial_2016}
  \bibinfo{author}{Metcalf, J.~L.} \emph{et~al.}
  \newblock \bibinfo{title}{Microbial community assembly and metabolic function during mammalian corpse decomposition}.
  \newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{351}}, \bibinfo{pages}{158--62} (\bibinfo{year}{2016}).
  
  \bibitem{fu_fungal_2019}
  \bibinfo{author}{Fu, X.} \emph{et~al.}
  \newblock \bibinfo{title}{Fungal succession during mammalian cadaver decomposition and potential forensic implications}.
  \newblock \emph{\bibinfo{journal}{Scientific Reports}} \textbf{\bibinfo{volume}{9}}, \bibinfo{pages}{12907} (\bibinfo{year}{2019}).
  
  \bibitem{dujon_genome_2004}
  \bibinfo{author}{Dujon, B.} \emph{et~al.}
  \newblock \bibinfo{title}{Genome evolution in yeasts}.
  \newblock \emph{\bibinfo{journal}{Nature}} \textbf{\bibinfo{volume}{430}}, \bibinfo{pages}{35--44} (\bibinfo{year}{2004}).
  
  \bibitem{haridas_genome_2013}
  \bibinfo{author}{Haridas, S.} \emph{et~al.}
  \newblock \bibinfo{title}{The genome and transcriptome of the pine saprophyte \textit{Ophiostoma piceae}, and a comparison with the bark beetle-associated pine pathogen textit{Grosmannia clavigera}}.
  \newblock \emph{\bibinfo{journal}{BMC Genomics}} \textbf{\bibinfo{volume}{14}}, \bibinfo{pages}{373} (\bibinfo{year}{2013}).
  
  \bibitem{notter_initial_2009}
  \bibinfo{author}{Notter, S.~J.}, \bibinfo{author}{Stuart, B.~H.}, \bibinfo{author}{Rowe, R.} \& \bibinfo{author}{Langlois, N.}
  \newblock \bibinfo{title}{The initial changes of fat deposits during the decomposition of human and pig remains}.
  \newblock \emph{\bibinfo{journal}{Journal of Forensic Sciences}} \textbf{\bibinfo{volume}{54}}, \bibinfo{pages}{195--201} (\bibinfo{year}{2009}).
  
  \bibitem{kok_characterization_1995}
  \bibinfo{author}{Kok, R.~G.} \emph{et~al.}
  \newblock \bibinfo{title}{Characterization of the extracellular lipase, {LipA}, of {Acinetobacter} calcoaceticus {BD413} and sequence analysis of the cloned structural gene}.
  \newblock \emph{\bibinfo{journal}{Molecular Microbiology}} \textbf{\bibinfo{volume}{15}}, \bibinfo{pages}{803--818} (\bibinfo{year}{1995}).
  
  \bibitem{hasan_influence_2006}
  \bibinfo{author}{Hasan, F.}, \bibinfo{author}{Shah, A.~A.} \& \bibinfo{author}{Hameed, A.}
  \newblock \bibinfo{title}{Influence of culture conditions on lipase production by {Bacillus} sp. {FH5}}.
  \newblock \emph{\bibinfo{journal}{Annals of Microbiology}} \textbf{\bibinfo{volume}{56}}, \bibinfo{pages}{247--252} (\bibinfo{year}{2006}).
  
  \bibitem{zouaoui_production_2012}
  \bibinfo{author}{Zouaoui, B.} \& \bibinfo{author}{Bouziane, A.}
  \newblock \bibinfo{title}{Production, optimization and characterization of the lipase from \textit{Pseudomonas aeruginosa}}.
  \newblock \emph{\bibinfo{journal}{Romanian Biotechnological Letters}} \textbf{\bibinfo{volume}{17}}, \bibinfo{pages}{7187--7193} (\bibinfo{year}{2012}).
  
  \bibitem{soler-jofra_hydroxylamine_2021}
  \bibinfo{author}{Soler-Jofra, A.}, \bibinfo{author}{Pérez, J.} \& \bibinfo{author}{van Loosdrecht, M. C.~M.}
  \newblock \bibinfo{title}{Hydroxylamine and the nitrogen cycle: {A} review}.
  \newblock \emph{\bibinfo{journal}{Water Research}} \textbf{\bibinfo{volume}{190}}, \bibinfo{pages}{116723} (\bibinfo{year}{2021}).
  
  \bibitem{yu_nitrosomonas_2018}
  \bibinfo{author}{Yu, R.}, \bibinfo{author}{Perez-Garcia, O.}, \bibinfo{author}{Lu, H.} \& \bibinfo{author}{Chandran, K.}
  \newblock \bibinfo{title}{\textit{Nitrosomonas europaea} adaptation to anoxic-oxic cycling: {Insights} from transcription analysis, proteomics and metabolic network modeling}.
  \newblock \emph{\bibinfo{journal}{Science of the Total Environment}} \textbf{\bibinfo{volume}{615}}, \bibinfo{pages}{1566--1573} (\bibinfo{year}{2018}).
  
  \bibitem{seidel_taurine_2019}
  \bibinfo{author}{Seidel, U.}, \bibinfo{author}{Huebbe, P.} \& \bibinfo{author}{Rimbach, G.}
  \newblock \bibinfo{title}{Taurine: {A} regulator of cellular redox homeostasis and skeletal muscle function}.
  \newblock \emph{\bibinfo{journal}{Molecular Nutrition \& Food Research}} \textbf{\bibinfo{volume}{63}}, \bibinfo{pages}{1800569} (\bibinfo{year}{2019}).
  
  \bibitem{mora-ortiz_thanatometabolomics_2019}
  \bibinfo{author}{Mora-Ortiz, M.}, \bibinfo{author}{Trichard, M.}, \bibinfo{author}{Oregioni, A.} \& \bibinfo{author}{Claus, S.~P.}
  \newblock \bibinfo{title}{Thanatometabolomics: introducing {NMR}-based metabolomics to identify metabolic biomarkers of the time of death}.
  \newblock \emph{\bibinfo{journal}{Metabolomics}} \textbf{\bibinfo{volume}{15}}, \bibinfo{pages}{37} (\bibinfo{year}{2019}).
  
  \bibitem{locci_1h_2019}
  \bibinfo{author}{Locci, E.} \emph{et~al.}
  \newblock \bibinfo{title}{A {1H} {NMR} metabolomic approach for the estimation of the time since death using aqueous humour: an animal model}.
  \newblock \emph{\bibinfo{journal}{Metabolomics}} \textbf{\bibinfo{volume}{15}}, \bibinfo{pages}{76} (\bibinfo{year}{2019}).
  
  \bibitem{zelentsova_post-mortem_2016}
  \bibinfo{author}{Zelentsova, E.~A.} \emph{et~al.}
  \newblock \bibinfo{title}{Post-mortem changes in the metabolomic compositions of rabbit blood, aqueous and vitreous humors}.
  \newblock \emph{\bibinfo{journal}{Metabolomics}} \textbf{\bibinfo{volume}{12}}, \bibinfo{pages}{172} (\bibinfo{year}{2016}).
  
  \bibitem{hoeland_katharina_investigating_2021}
  \bibinfo{author}{Hoeland, K.~M.}
  \newblock \emph{\bibinfo{title}{Investigating the potential of postmortem metabolomics in mammalian decomposition studies in outdoor settings}}.
  \newblock Ph.D. thesis, \bibinfo{school}{University of Tennessee-Knoxville}, \bibinfo{address}{https://trace.tennessee.edu/utk\_graddiss/7000} (\bibinfo{year}{2021}).
  
  \bibitem{javan_human_2016}
  \bibinfo{author}{Javan, G.~T.} \emph{et~al.}
  \newblock \bibinfo{title}{Human thanatomicrobiome succession and time since death}.
  \newblock \emph{\bibinfo{journal}{Scientific Reports}} \textbf{\bibinfo{volume}{6}}, \bibinfo{pages}{29598} (\bibinfo{year}{2016}).
  
  \bibitem{javan_cadaver_2017}
  \bibinfo{author}{Javan, G.~T.}, \bibinfo{author}{Finley, S.~J.}, \bibinfo{author}{Smith, T.}, \bibinfo{author}{Miller, J.} \& \bibinfo{author}{Wilkinson, J.~E.}
  \newblock \bibinfo{title}{Cadaver thanatomicrobiome signatures: the ubiquitous nature of {Clostridium} species in human decomposition}.
  \newblock \emph{\bibinfo{journal}{Frontiers in Microbiology}} \textbf{\bibinfo{volume}{8}}, \bibinfo{pages}{2096} (\bibinfo{year}{2017}).
  
  \bibitem{debruyn_postmortem_2017}
  \bibinfo{author}{DeBruyn, J.~M.} \& \bibinfo{author}{Hauther, K.~A.}
  \newblock \bibinfo{title}{Postmortem succession of gut microbial communities in deceased human subjects}.
  \newblock \emph{\bibinfo{journal}{Peerj}} \textbf{\bibinfo{volume}{5}}, \bibinfo{pages}{e3437} (\bibinfo{year}{2017}).
  
  \bibitem{cook_metabolism_2006}
  \bibinfo{author}{Cook, A.~M.} \& \bibinfo{author}{Denger, K.}
  \newblock \emph{\bibinfo{title}{Metabolism of taurine in microorganisms}}, \bibinfo{pages}{3--13} (\bibinfo{year}{2006}).
  
  \bibitem{kertesz_riding_2000}
  \bibinfo{author}{Kertesz, M.~A.}
  \newblock \bibinfo{title}{Riding the sulfur cycle – metabolism of sulfonates and sulfate esters in {Gram}-negative bacteria}.
  \newblock \emph{\bibinfo{journal}{FEMS Microbiology Reviews}} \textbf{\bibinfo{volume}{24}}, \bibinfo{pages}{135--175} (\bibinfo{year}{2000}).
  
  \bibitem{bruggemann_enzymes_2004}
  \bibinfo{author}{Brüggemann, C.}, \bibinfo{author}{Denger, K.}, \bibinfo{author}{Cook, A.~M.} \& \bibinfo{author}{Ruff, J.}
  \newblock \bibinfo{title}{Enzymes and genes of taurine and isethionate dissimilation in \textit{Paracoccus denitrificans}}.
  \newblock \emph{\bibinfo{journal}{Microbiology}} \textbf{\bibinfo{volume}{150}}, \bibinfo{pages}{805--816} (\bibinfo{year}{2004}).
  
  \bibitem{keenan_spatial_2018}
  \bibinfo{author}{Keenan, S.~W.} \emph{et~al.}
  \newblock \bibinfo{title}{Spatial impacts of a multi-individual grave on microbial and microfaunal communities and soil biogeochemistry}.
  \newblock \emph{\bibinfo{journal}{PLoS One}} \textbf{\bibinfo{volume}{13}}, \bibinfo{pages}{e0208845} (\bibinfo{year}{2018}).
  
  \bibitem{payne_summer_1965}
  \bibinfo{author}{Payne, J.~A.}
  \newblock \bibinfo{title}{A summer carrion study of the baby pig \textit{Sus Scrofa} linnaeus}.
  \newblock \emph{\bibinfo{journal}{Ecology}} \textbf{\bibinfo{volume}{46}}, \bibinfo{pages}{592--602} (\bibinfo{year}{1965}).
  
  \bibitem{apprill_minor_2015}
  \bibinfo{author}{Apprill, A.}, \bibinfo{author}{McNally, S.}, \bibinfo{author}{Parsons, R.} \& \bibinfo{author}{Weber, L.}
  \newblock \bibinfo{title}{Minor revision to {V4} region {SSU} {rRNA} {806R} gene primer greatly increases detection of {SAR11} bacterioplankton}.
  \newblock \emph{\bibinfo{journal}{Aquatic Microbial Ecology}} \textbf{\bibinfo{volume}{75}}, \bibinfo{pages}{129--137} (\bibinfo{year}{2015}).
  
  \bibitem{parada_every_2016}
  \bibinfo{author}{Parada, A.~E.}, \bibinfo{author}{Needham, D.~M.} \& \bibinfo{author}{Fuhrman, J.~A.}
  \newblock \bibinfo{title}{Every base matters: assessing small subunit {rRNA} primers for marine microbiomes with mock communities, time series and global field samples}.
  \newblock \emph{\bibinfo{journal}{Environmental Microbiology}} \textbf{\bibinfo{volume}{18}}, \bibinfo{pages}{1403--14} (\bibinfo{year}{2016}).
  
  \bibitem{arkin_kbase_2018}
  \bibinfo{author}{Arkin, A.~P.} \emph{et~al.}
  \newblock \bibinfo{title}{{KBase}: {The} {United} {States} {Department} of {Energy} {Systems} {Biology} {Knowledgebase}}.
  \newblock \emph{\bibinfo{journal}{Nature Biotechnology}} \textbf{\bibinfo{volume}{36}}, \bibinfo{pages}{566--569} (\bibinfo{year}{2018}).
  
  \bibitem{bolger_trimmomatic_2014}
  \bibinfo{author}{Bolger, A.~M.}, \bibinfo{author}{Lohse, M.} \& \bibinfo{author}{Usadel, B.}
  \newblock \bibinfo{title}{Trimmomatic: a flexible trimmer for {Illumina} sequence data}.
  \newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{30}}, \bibinfo{pages}{2114--2120} (\bibinfo{year}{2014}).
  
  \bibitem{bushnell_bbtools_2014}
  \bibinfo{author}{Bushnell, B.}
  \newblock \bibinfo{title}{{BBTools} software package} (\bibinfo{year}{2014}).
  
  \bibitem{li_megahit_2015}
  \bibinfo{author}{Li, D.}, \bibinfo{author}{Liu, C.-M.}, \bibinfo{author}{Luo, R.}, \bibinfo{author}{Sadakane, K.} \& \bibinfo{author}{Lam, T.-W.}
  \newblock \bibinfo{title}{{MEGAHIT}: an ultra-fast single-node solution for large and complex metagenomics assembly via succinct de {Bruijn} graph}.
  \newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{1674--1676} (\bibinfo{year}{2015}).
  
  \bibitem{hyatt_prodigal_2010}
  \bibinfo{author}{Hyatt, D.} \emph{et~al.}
  \newblock \bibinfo{title}{Prodigal: prokaryotic gene recognition and translation initiation site identification}.
  \newblock \emph{\bibinfo{journal}{BMC Bioinformatics}} \textbf{\bibinfo{volume}{11}}, \bibinfo{pages}{119} (\bibinfo{year}{2010}).
  
  \bibitem{cantalapiedra_eggnog-mapper_2021}
  \bibinfo{author}{Cantalapiedra, C.~P.}, \bibinfo{author}{Hernández-Plaza, A.}, \bibinfo{author}{Letunic, I.}, \bibinfo{author}{Bork, P.} \& \bibinfo{author}{Huerta-Cepas, J.}
  \newblock \bibinfo{title}{{eggNOG}-mapper v2: functional annotation, orthology assignments, and domain prediction at the metagenomic scale}.
  \newblock \emph{\bibinfo{journal}{Molecular Biology and Evolution}} \textbf{\bibinfo{volume}{38}}, \bibinfo{pages}{5825--5829} (\bibinfo{year}{2021}).
  
  \bibitem{buchfink_sensitive_2021}
  \bibinfo{author}{Buchfink, B.}, \bibinfo{author}{Reuter, K.} \& \bibinfo{author}{Drost, H.-G.}
  \newblock \bibinfo{title}{Sensitive protein alignments at tree-of-life scale using {DIAMOND}}.
  \newblock \emph{\bibinfo{journal}{Nature Methods}} \textbf{\bibinfo{volume}{18}}, \bibinfo{pages}{366--368} (\bibinfo{year}{2021}).
  
  \bibitem{robinson_edger_2010}
  \bibinfo{author}{Robinson, M.~D.}, \bibinfo{author}{McCarthy, D.~J.} \& \bibinfo{author}{Smyth, G.~K.}
  \newblock \bibinfo{title}{{edgeR}: a {Bioconductor} package for differential expression analysis of digital gene expression data}.
  \newblock \emph{\bibinfo{journal}{Bioinformatics}} \textbf{\bibinfo{volume}{26}}, \bibinfo{pages}{139--140} (\bibinfo{year}{2010}).
  
  \bibitem{smyth_limma_2005}
  \bibinfo{author}{Smyth, G.~K.}
  \newblock \bibinfo{title}{ in \textit{limma: {Linear} {Models} for {Microarray} {Data}}} (eds \bibinfo{editor}{Gentleman, R.}, \bibinfo{editor}{Carey, V.~J.}, \bibinfo{editor}{Huber, W.}, \bibinfo{editor}{Irizarry, R.~A.} \& \bibinfo{editor}{Dudoit, S.}) \emph{\bibinfo{booktitle}{Bioinformatics and {Computational} {Biology} {Solutions} {Using} {R} and {Bioconductor}}} \bibinfo{pages}{397--420} (\bibinfo{publisher}{Springer New York}, \bibinfo{address}{New York, NY}, \bibinfo{year}{2005}).
  
  \bibitem{phipson_differential_2020}
  \bibinfo{author}{Phipson, B.} \emph{et~al.}
  \newblock \bibinfo{title}{Differential expression analysis} (\bibinfo{year}{2020}).
  ...
  \newblock \emph{\bibinfo{title}{ggplot2: {Elegant} {Graphics} for {Data} {Analysis}}}  (\bibinfo{publisher}{Springer-Verlag New York}, \bibinfo{year}{2016}).
  \newblock \urlprefix\url{https://ggplot2.tidyverse.org}.
  
  \bibitem{oksanen_vegan_2024}
  \bibinfo{author}{Oksanen, J.} \emph{et~al.}
  \newblock \emph{\bibinfo{title}{vegan: {Community} {Ecology} {Package}}}  (\bibinfo{year}{2024}).
